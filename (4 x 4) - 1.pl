...
cell(1,1,2). cell(1,2,2). cell(1,3,2). cell(1,4,4).
cell(2,1,1). cell(2,2,4). cell(2,3,2). cell(2,4,3).
cell(3,1,2). cell(3,2,3). cell(3,3,2). cell(3,4,1).
cell(4,1,3). cell(4,2,4). cell(4,3,1). cell(4,4,2).
...
setBlackRow(I ,J) :- cell(I ,J ,Val) ,cell(I ,K ,V1) ,V1 = Val ,K \= J ,setBlack(I ,K) ,!.
setBlackColumn(I ,J) :- cell(I ,J ,Val) ,cell(K ,J ,V1) ,V1 = Val ,K\= I ,setBlack(K ,J) ,!.
