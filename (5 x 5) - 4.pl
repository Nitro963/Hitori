...
cell(1,1,5). cell(1,2,1). cell(1,3,2). cell(1,4,3). cell(1,5,3). 
cell(2,1,3). cell(2,2,5). cell(2,3,4). cell(2,4,2). cell(2,5,1). 
cell(3,1,1). cell(3,2,2). cell(3,3,3). cell(3,4,5). cell(3,5,5). 
cell(4,1,2). cell(4,2,4). cell(4,3,5). cell(4,4,1). cell(4,5,3). 
cell(5,1,4). cell(5,2,4). cell(5,3,1). cell(5,4,5). cell(5,5,5). 
