...
cell(1,1,9). cell(1,2,10). cell(1,3,4). cell(1,4,10). cell(1,5,5). cell(1,6,9). cell(1,7,8). cell(1,8,6). cell(1,9,8). cell(1,10,2). 
cell(2,1,10). cell(2,2,8). cell(2,3,9). cell(2,4,1). cell(2,5,6). cell(2,6,5). cell(2,7,4). cell(2,8,5). cell(2,9,1). cell(2,10,3). 
cell(3,1,10). cell(3,2,6). cell(3,3,10). cell(3,4,8). cell(3,5,4). cell(3,6,9). cell(3,7,5). cell(3,8,10). cell(3,9,6). cell(3,10,7). 
cell(4,1,3). cell(4,2,9). cell(4,3,10). cell(4,4,2). cell(4,5,2). cell(4,6,7). cell(4,7,10). cell(4,8,5). cell(4,9,4). cell(4,10,1). 
cell(5,1,7). cell(5,2,4). cell(5,3,8). cell(5,4,1). cell(5,5,8). cell(5,6,2). cell(5,7,6). cell(5,8,3). cell(5,9,1). cell(5,10,5). 
cell(6,1,8). cell(6,2,3). cell(6,3,1). cell(6,4,5). cell(6,5,9). cell(6,6,6). cell(6,7,7). cell(6,8,4). cell(6,9,10). cell(6,10,4). 
cell(7,1,10). cell(7,2,9). cell(7,3,8). cell(7,4,5). cell(7,5,10). cell(7,6,4). cell(7,7,7). cell(7,8,2). cell(7,9,6). cell(7,10,10). 
cell(8,1,5). cell(8,2,1). cell(8,3,2). cell(8,4,7). cell(8,5,1). cell(8,6,9). cell(8,7,3). cell(8,8,7). cell(8,9,8). cell(8,10,6). 
cell(9,1,6). cell(9,2,7). cell(9,3,6). cell(9,4,9). cell(9,5,2). cell(9,6,10). cell(9,7,1). cell(9,8,4). cell(9,9,5). cell(9,10,6). 
cell(10,1,6). cell(10,2,10). cell(10,3,3). cell(10,4,8). cell(10,5,7). cell(10,6,8). cell(10,7,2). cell(10,8,1). cell(10,9,2). cell(10,10,9). 
