...
cell(1,1,9). cell(1,2,6). cell(1,3,8). cell(1,4,10). cell(1,5,11). cell(1,6,12). cell(1,7,9). cell(1,8,14). cell(1,9,2). cell(1,10,1). cell(1,11,12). cell(1,12,15). cell(1,13,5). cell(1,14,5). cell(1,15,7). 
cell(2,1,11). cell(2,2,11). cell(2,3,3). cell(2,4,2). cell(2,5,6). cell(2,6,2). cell(2,7,8). cell(2,8,11). cell(2,9,4). cell(2,10,11). cell(2,11,9). cell(2,12,1). cell(2,13,7). cell(2,14,10). cell(2,15,7). 
cell(3,1,3). cell(3,2,7). cell(3,3,1). cell(3,4,6). cell(3,5,14). cell(3,6,13). cell(3,7,4). cell(3,8,12). cell(3,9,9). cell(3,10,10). cell(3,11,9). cell(3,12,14). cell(3,13,12). cell(3,14,8). cell(3,15,15). 
cell(4,1,5). cell(4,2,6). cell(4,3,10). cell(4,4,5). cell(4,5,3). cell(4,6,2). cell(4,7,9). cell(4,8,8). cell(4,9,10). cell(4,10,11). cell(4,11,1). cell(4,12,9). cell(4,13,9). cell(4,14,4). cell(4,15,9). 
cell(5,1,6). cell(5,2,4). cell(5,3,7). cell(5,4,9). cell(5,5,1). cell(5,6,5). cell(5,7,1). cell(5,8,6). cell(5,9,3). cell(5,10,8). cell(5,11,6). cell(5,12,13). cell(5,13,14). cell(5,14,2). cell(5,15,10). 
cell(6,1,1). cell(6,2,3). cell(6,3,6). cell(6,4,3). cell(6,5,4). cell(6,6,3). cell(6,7,10). cell(6,8,5). cell(6,9,10). cell(6,10,12). cell(6,11,3). cell(6,12,11). cell(6,13,2). cell(6,14,13). cell(6,15,9). 
cell(7,1,14). cell(7,2,1). cell(7,3,11). cell(7,4,5). cell(7,5,7). cell(7,6,11). cell(7,7,11). cell(7,8,3). cell(7,9,15). cell(7,10,1). cell(7,11,13). cell(7,12,10). cell(7,13,10). cell(7,14,1). cell(7,15,8). 
cell(8,1,9). cell(8,2,13). cell(8,3,12). cell(8,4,11). cell(8,5,13). cell(8,6,8). cell(8,7,6). cell(8,8,4). cell(8,9,1). cell(8,10,2). cell(8,11,12). cell(8,12,7). cell(8,13,5). cell(8,14,14). cell(8,15,11). 
cell(9,1,12). cell(9,2,2). cell(9,3,14). cell(9,4,11). cell(9,5,5). cell(9,6,4). cell(9,7,11). cell(9,8,14). cell(9,9,10). cell(9,10,6). cell(9,11,6). cell(9,12,5). cell(9,13,3). cell(9,14,7). cell(9,15,1). 
cell(10,1,10). cell(10,2,2). cell(10,3,2). cell(10,4,12). cell(10,5,9). cell(10,6,1). cell(10,7,11). cell(10,8,6). cell(10,9,11). cell(10,10,7). cell(10,11,8). cell(10,12,3). cell(10,13,4). cell(10,14,14). cell(10,15,11). 
cell(11,1,3). cell(11,2,11). cell(11,3,8). cell(11,4,7). cell(11,5,8). cell(11,6,4). cell(11,7,9). cell(11,8,1). cell(11,9,13). cell(11,10,6). cell(11,11,10). cell(11,12,6). cell(11,13,4). cell(11,14,15). cell(11,15,2). 
cell(12,1,8). cell(12,2,15). cell(12,3,3). cell(12,4,1). cell(12,5,14). cell(12,6,10). cell(12,7,9). cell(12,8,2). cell(12,9,6). cell(12,10,9). cell(12,11,12). cell(12,12,4). cell(12,13,6). cell(12,14,9). cell(12,15,5). 
cell(13,1,9). cell(13,2,9). cell(13,3,13). cell(13,4,4). cell(13,5,12). cell(13,6,7). cell(13,7,14). cell(13,8,10). cell(13,9,11). cell(13,10,4). cell(13,11,15). cell(13,12,5). cell(13,13,7). cell(13,14,6). cell(13,15,3). 
cell(14,1,7). cell(14,2,3). cell(14,3,3). cell(14,4,4). cell(14,5,14). cell(14,6,9). cell(14,7,1). cell(14,8,13). cell(14,9,14). cell(14,10,5). cell(14,11,12). cell(14,12,14). cell(14,13,8). cell(14,14,14). cell(14,15,6). 
cell(15,1,15). cell(15,2,9). cell(15,3,9). cell(15,4,14). cell(15,5,13). cell(15,6,6). cell(15,7,5). cell(15,8,10). cell(15,9,8). cell(15,10,4). cell(15,11,11). cell(15,12,10). cell(15,13,2). cell(15,14,1). cell(15,15,2). 
