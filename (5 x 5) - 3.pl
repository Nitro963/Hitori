...
cell(1,1,1). cell(1,2,2). cell(1,3,3). cell(1,4,5). cell(1,5,3). 
cell(2,1,4). cell(2,2,3). cell(2,3,3). cell(2,4,2). cell(2,5,2). 
cell(3,1,5). cell(3,2,3). cell(3,3,4). cell(3,4,1). cell(3,5,4). 
cell(4,1,4). cell(4,2,1). cell(4,3,4). cell(4,4,3). cell(4,5,4). 
cell(5,1,3). cell(5,2,5). cell(5,3,5). cell(5,4,4). cell(5,5,1). 
