...
cell(1,1,2). cell(1,2,2). cell(1,3,9). cell(1,4,5). 
cell(2,1,1). cell(2,2,2). cell(2,3,10). cell(2,4,12). 
cell(3,1,15). cell(3,2,2). cell(3,3,2). cell(3,4,20). 
cell(4,1,5). cell(4,2,7). cell(4,3,4). cell(4,4,3). 
