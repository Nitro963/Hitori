...
cell(1,1,4). cell(1,2,1). cell(1,3,5). cell(1,4,3). cell(1,5,2). 
cell(2,1,1). cell(2,2,2). cell(2,3,3). cell(2,4,5). cell(2,5,5). 
cell(3,1,3). cell(3,2,4). cell(3,3,4). cell(3,4,5). cell(3,5,1). 
cell(4,1,3). cell(4,2,5). cell(4,3,1). cell(4,4,5). cell(4,5,4). 
cell(5,1,5). cell(5,2,2). cell(5,3,5). cell(5,4,1). cell(5,5,3). 
...
setBlackRow(I ,J ,Val) :- size(N ,_) ,for(1 ,N ,K) ,cell(I ,K ,V1) ,V1 = Val ,K \= J ,setBlack(I ,K) ,!.
setBlackColumn(I ,J ,Val) :- size(_ ,M) ,for(1 ,M ,K) ,cell(K ,J ,V1) ,V1 = Val ,K\= I ,setBlack(K ,J) ,!.
