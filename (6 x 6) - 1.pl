...
cell(1,1,6). cell(1,2,1). cell(1,3,4). cell(1,4,5). cell(1,5,6). cell(1,6,2). 
cell(2,1,4). cell(2,2,2). cell(2,3,3). cell(2,4,3). cell(2,5,1). cell(2,6,4). 
cell(3,1,3). cell(3,2,6). cell(3,3,1). cell(3,4,2). cell(3,5,3). cell(3,6,5). 
cell(4,1,2). cell(4,2,4). cell(4,3,3). cell(4,4,1). cell(4,5,2). cell(4,6,6). 
cell(5,1,1). cell(5,2,3). cell(5,3,2). cell(5,4,4). cell(5,5,6). cell(5,6,4). 
cell(6,1,4). cell(6,2,5). cell(6,3,5). cell(6,4,5). cell(6,5,3). cell(6,6,1). 
