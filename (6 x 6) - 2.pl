...
cell(1,1,1). cell(1,2,4). cell(1,3,2). cell(1,4,3). cell(1,5,5). cell(1,6,4). 
cell(2,1,4). cell(2,2,2). cell(2,3,5). cell(2,4,1). cell(2,5,5). cell(2,6,5). 
cell(3,1,5). cell(3,2,2). cell(3,3,1). cell(3,4,6). cell(3,5,3). cell(3,6,4). 
cell(4,1,4). cell(4,2,6). cell(4,3,5). cell(4,4,5). cell(4,5,5). cell(4,6,2). 
cell(5,1,3). cell(5,2,1). cell(5,3,6). cell(5,4,4). cell(5,5,2). cell(5,6,4). 
cell(6,1,1). cell(6,2,1). cell(6,3,5). cell(6,4,3). cell(6,5,6). cell(6,6,3). 
