...
cell(1,1,7). cell(1,2,5). cell(1,3,6). cell(1,4,3). cell(1,5,3). cell(1,6,4). cell(1,7,2).
cell(2,1,4). cell(2,2,3). cell(2,3,1). cell(2,4,1). cell(2,5,4). cell(2,6,6). cell(2,7,5).
cell(3,1,6). cell(3,2,4). cell(3,3,7). cell(3,4,2). cell(3,5,2). cell(3,6,1). cell(3,7,5).
cell(4,1,1). cell(4,2,7). cell(4,3,5). cell(4,4,7). cell(4,5,1). cell(4,6,1). cell(4,7,3).
cell(5,1,4). cell(5,2,7). cell(5,3,2). cell(5,4,7). cell(5,5,6). cell(5,6,5). cell(5,7,1).
cell(6,1,2). cell(6,2,1). cell(6,3,3). cell(6,4,3). cell(6,5,5). cell(6,6,7). cell(6,7,4).
cell(7,1,1). cell(7,2,5). cell(7,3,4). cell(7,4,5). cell(7,5,3). cell(7,6,3). cell(7,7,1).
