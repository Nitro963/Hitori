...
cell(1,1,5). cell(1,2,2). cell(1,3,8). cell(1,4,8). cell(1,5,3). cell(1,6,4). cell(1,7,7). cell(1,8,1).
cell(2,1,2). cell(2,2,1). cell(2,3,6). cell(2,4,4). cell(2,5,6). cell(2,6,5). cell(2,7,5). cell(2,8,7).
cell(3,1,8). cell(3,2,4). cell(3,3,5). cell(3,4,4). cell(3,5,6). cell(3,6,5). cell(3,7,5). cell(3,8,7).
cell(4,1,3). cell(4,2,4). cell(4,3,4). cell(4,4,6). cell(4,5,6). cell(4,6,2). cell(4,7,3). cell(4,8,8).
cell(5,1,6). cell(5,2,2). cell(5,3,7). cell(5,4,2). cell(5,5,1). cell(5,6,4). cell(5,7,8). cell(5,8,3).
cell(6,1,1). cell(6,2,6). cell(6,3,6). cell(6,4,3). cell(6,5,8). cell(6,6,7). cell(6,7,5). cell(6,8,2).
cell(7,1,5). cell(7,2,3). cell(7,3,1). cell(7,4,4). cell(7,5,4). cell(7,6,2). cell(7,7,6). cell(7,8,3).
cell(8,1,4). cell(8,2,5). cell(8,3,8). cell(8,4,7). cell(8,5,8). cell(8,6,1). cell(8,7,3). cell(8,8,4).
